module.exports = app => {
  ...
  router
    ...
    .get('/user/videos/feed', auth, controller.video.getUserFeedVideos) // 获取用户关注的频道列表
    ...
    .get('/videos/:videoId/comments', auth, controller.video.getVideoComments) // 获取视频评论列表
    .delete(
    ...
    .post('/videos/:videoId/dislike', auth, controller.video.dislikeVideo) // 喜欢视频
